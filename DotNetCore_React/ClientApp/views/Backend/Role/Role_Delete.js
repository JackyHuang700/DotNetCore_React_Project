...
class Role_Delete extends Component {
    ...
    render() {
        return ( <
            ...
            validMessage = {
                { required: 'createDate is reduired.' } }
            onChange = { this.handleInputChange }
            ...
            validMessage = {
                { required: 'createUser is reduired.' } }
            onChange = { this.handleInputChange }
            ...
            onClick = { this.Button_Submit } > 確認刪除 < /button> <
            /div> <
            /form> <
            /div> <
            /div> <
